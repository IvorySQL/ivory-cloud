/* ------------------------------------------------
 *
 * 文件名称: OrderContant.java
 *
 * 摘要：
 *      此文件包含UserTO。
 *
 * 作者信息及编写日期：chushaolin@highgo.com，20200929.
 *
 * 修改信息：
 * 2020.09.29，初少林添加常量信息.
 * 2021.09.29，卢存桥添加虚拟机订阅常量信息.
 *
 * 版权信息：
 * Copyright (c) 2009-2019, HighGo Software Co.,Ltd. All rights reserved.
 *
 *文件路径：
 *		src/main/java/com/highgo/cloud/contants/OrderContant.java
 *
 *-------------------------------------------------
 */
