...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .antMatchers(routineAcessUrl)
                .hasAnyAuthority(UserConstants.ROLE_ADMIN_NAME, UserConstants.ROLE_ROUTINE_NAME)
                ...
                // 指定自定义form表单请求的路径
                .loginProcessingUrl(completeLoginUrl).usernameParameter(UrlConstants.LOGIN_FORM_USERNAME_KEY)
                .passwordParameter(UrlConstants.LOGIN_FORM_PASSWORD_KEY)
                // 自定义认证成功或者失败的返回json
    ...
    private String[] joinSecurityIgnoreResource(String[] securityIgnoreStatic, String[] securityIgnoreAPI) {
        ...
        System.arraycopy(securityIgnoreAPI, 0, securityIgnoreResource, securityIgnoreStatic.length,
                securityIgnoreAPI.length);
