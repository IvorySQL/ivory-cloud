 ...
 * watcher工厂类
 */
public abstract class AbstractWatcherFactory implements WatcherFactory {

    private static final Logger logger = LoggerFactory.getLogger(AbstractWatcherFactory.class);
    /**
     * 已启动watcher的集群缓存
     */
