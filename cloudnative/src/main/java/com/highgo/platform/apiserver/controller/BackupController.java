...
public class BackupController {
    ...
    public BackupVO createBackup(@Validated @PathVariable String id, @RequestBody CreateBackupVO createBackupParam) {
        logger.info("[BackupController.createBackup] instanceid is {} createBackupParam is {}", id,
                createBackupParam.toString());
    ...
    public BackupPolicyVO modifyBackupPolicy(@Validated @PathVariable String id,
            @RequestBody ModifyBackupPolicyVO modifyBackupPolicyParam) {
        logger.info("[BackupController.modifyBackupPolicy] instanceid is {} modifyBackupPolicyParam is {}", id,
                modifyBackupPolicyParam.toString());
    ...
    public ActionResponse modifyBackupSwitch(@Validated @PathVariable String id,
            @RequestBody ModifyAutoBackupSwitchVO modifyAutoBackupSwitchParam) {
        logger.info("[BackupController.modifyBackupSwitch] instanceid is {} modifyAutoBackupSwitchParam is {}", id,
                modifyAutoBackupSwitchParam.toString());
